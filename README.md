...
> 一套面向中文研究者的 Claude Code Agent Skills，把学位论文/期刊论文写作拆成 8 主线 + 2 可选阶段，按 **选题 → 文献 → 写作 → 质检 → 答辩** 主线推进，支持断点续办。
...
| S-DATA | [`paper-data-analysis/`](paper-data-analysis/) | 数据·可选 | 实证/量化论文：GLM4 零代码分析 + Codex 脏数据核查 |
...
| S6b | [`paper-s6b-peer-review/`](paper-s6b-peer-review/) | 评议·可选 | 顶刊同行评议（贡献度分级 + 修订路线图） |
...
cp -R paper-os paper-s1-topic paper-s2-literature paper-s3-writing \
         paper-data-analysis paper-s4-discussion paper-s5-checklist \
         paper-s6-factcheck paper-s6b-peer-review paper-s7-ppt paper-s8-defense \
         ~/.claude/skills/
```
